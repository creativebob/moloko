...
class ChallengePolicy
{
    ...
    public function view(User $user, Challenge $model)
    {
    ...
    public function update(User $user, Challenge $model)
    { 
        $result = $this->getstatus($this->entity_name, $model, 'update', $this->entity_dependence);
        return $result;
    }

    public function delete(User $user, Challenge $model)
    {
        $result = $this->getstatus($this->entity_name, $model, 'delete', $this->entity_dependence);
        return $result;
    }
    
    public function moderator(User $user, Challenge $model)
    {
        $result = $this->getstatus($this->entity_name, $model, 'moderator', $this->entity_dependence);
        return $result;
    }   

    public function automoderate(User $user, Challenge $model)
    {
    ...
    public function system(User $user, Challenge $model)
    {
