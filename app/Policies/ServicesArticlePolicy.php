...
class ServicesArticlePolicy
{
    ...
    protected $entity_name = 'services_info';
    ...
    public function view(User $user, ServicesArticle $model)
    {
    ...
    public function update(User $user, ServicesArticle $model)
    { 
    ...
    public function delete(User $user, ServicesArticle $model)
    {
        $result = $this->getstatus($this->entity_name, $model, 'delete', $this->entity_dependence);
        return $result;
    }

    public function moderator(User $user, ServicesArticle $model)
    {
        $result = $this->getstatus($this->entity_name, $model, 'moderator', $this->entity_dependence);
        return $result;
    }

    public function automoderate(User $user, ServicesArticle $model)
    {
    ...
    public function system(User $user, ServicesArticle $model)
    {
