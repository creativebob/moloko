...
class ProductsCategoryPolicy
{
    ...
    public function view(User $user, ProductsCategory $model)
    {
    ...
    public function update(User $user, ProductsCategory $model)
    { 
        $result = $this->getstatus($this->entity_name, $model, 'update', $this->entity_dependence);
        return $result;
    }

    public function delete(User $user, ProductsCategory $model)
    {
    ...
    public function automoderate(User $user, ProductsCategory $model)
    {
