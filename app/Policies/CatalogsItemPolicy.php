...
class CatalogsItemPolicy
{
    use HandlesAuthorization;
    use PoliticTrait;

    protected $entity_name = 'catalogs_items';
    ...
    public function view(User $user, CatalogsItem $model)
    {
    ...
    public function update(User $user, CatalogsItem $model)
    {
        return $this->getstatus($this->entity_name, $model, 'update', $this->entity_dependence);
    }

    public function delete(User $user, CatalogsItem $model)
    {
    ...
    public function moderator(User $user, CatalogsItem $model)
    {
        return $this->getstatus($this->entity_name, $model, 'moderator', $this->entity_dependence);
    }

    public function automoderate(User $user, CatalogsItem $model)
    {
    ...
    public function system(User $user, CatalogsItem $model)
    {
