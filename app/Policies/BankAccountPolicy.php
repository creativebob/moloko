...
class BankAccountPolicy
{
    ...
    public function moderator(User $user, BankAccount $model)
    {
        $result = $this->getstatus($this->entity_name, $model, 'moderator', $this->entity_dependence);
        return $result;
    }

    public function automoderate(User $user, BankAccount $model)
    {
    ...
    public function system(User $user, BankAccount $model)
    {
