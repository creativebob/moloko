...
class RawsCategoryPolicy
{
    ...
    public function view(User $user, RawsCategory $model)
    {
    ...
    public function update(User $user, RawsCategory $model)
    { 
        $result = $this->getstatus($this->entity_name, $model, 'update', $this->entity_dependence);
        return $result;
    }

    public function delete(User $user, RawsCategory $model)
    {
        $result = $this->getstatus($this->entity_name, $model, 'delete', $this->entity_dependence);
        return $result;
    }

    public function moderator(User $user, RawsCategory $model)
    {
        $result = $this->getstatus($this->entity_name, $model, 'moderator', $this->entity_dependence);
        return $result;
    }

    public function automoderate(User $user, RawsCategory $model)
    {
    ...
    public function system(User $user, RawsCategory $model)
    {
