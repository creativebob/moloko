...
class SupplierPolicy
{
    ...
    public function moderator(User $user, Supplier $model)
    {
        $result = $this->getstatus($this->entity_name, $model, 'moderator', $this->entity_dependence);
        return $result;
    }

    public function automoderate(User $user, Supplier $model)
    {
    ...
    public function system(User $user, Supplier $model)
    {
