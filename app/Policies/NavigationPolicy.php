...
class NavigationPolicy
{
    ...
    public function moderator(User $user, Navigation $model)
    {
        return $this->getstatus($this->entity_name, $model, 'moderator', $this->entity_dependence);
    }

    public function automoderate(User $user, Navigation $model)
    {
    ...
    public function system(User $user, Navigation $model)
    {
