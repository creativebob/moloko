...
class DealerPolicy
{
    ...
    public function view(User $user, Dealer $model)
    {
    ...
    public function delete(User $user, Dealer $model)
    {
        $result = $this->getstatus($this->entity_name, $model, 'delete', $this->entity_dependence);
        return $result;
    }

    public function moderator(User $user, Dealer $model)
    {
        $result = $this->getstatus($this->entity_name, $model, 'moderator', $this->entity_dependence);
        return $result;
    }

    public function automoderate(User $user, Dealer $model)
    {
    ...
    public function system(User $user, Dealer $model)
    {
