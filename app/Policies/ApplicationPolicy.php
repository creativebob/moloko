...
class ApplicationPolicy
{
    ...
    public function moderator(User $user, Application $model)
    {
        $result = $this->getstatus($this->entity_name, $model, 'moderator', $this->entity_dependence);
        return $result;
    }

    public function automoderate(User $user, Application $model)
    {
    ...
    public function system(User $user, Application $model)
    {
