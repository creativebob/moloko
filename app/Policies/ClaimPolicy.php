...
class ClaimPolicy
{
    ...
    public function view(User $user, Claim $model)
    {
    ...
    public function update(User $user, Claim $model)
    { 
        $result = $this->getstatus($this->entity_name, $model, 'update', $this->entity_dependence);
        return $result;
    }

    public function delete(User $user, Claim $model)
    {
        $result = $this->getstatus($this->entity_name, $model, 'delete', $this->entity_dependence);
        return $result;
    }
    
    public function moderator(User $user, Claim $model)
    {
        $result = $this->getstatus($this->entity_name, $model, 'moderator', $this->entity_dependence);
        return $result;
    }   

    public function automoderate(User $user, Claim $model)
    {
    ...
    public function system(User $user, Claim $model)
    {
