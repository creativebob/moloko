...
class StagePolicy
{
    ...
    public function view(User $user, Stage $model)
    {
    ...
    public function update(User $user, Stage $model)
    { 
        $result = $this->getstatus($this->entity_name, $model, 'update', $this->entity_dependence);
        return $result;
    }

    public function delete(User $user, Stage $model)
    {
        $result = $this->getstatus($this->entity_name, $model, 'delete', $this->entity_dependence);
        return $result;
    }
    
    public function moderator(User $user, Stage $model)
    {
        $result = $this->getstatus($this->entity_name, $model, 'moderator', $this->entity_dependence);
        return $result;
    }

    public function automoderate(User $user, Stage $model)
    {
    ...
    public function system(User $user, Stage $model)
    {
