...
class ProductsCategoryController extends Controller
{
    ...
    public function create(Request $request, $type)
    {
        ...
        if (isset($request->parent_id)) {
            ...
            return view('products_categories.create-medium', compact('products_category', 'products_categories_list', 'type', 'products_modes_list', 'units_categories_list', 'products_list'));
        } else {
    ...
    public function edit(Request $request, $id)
    {
        ...
        $properties_list = $properties->pluck('name', 'id');
         ...
         // Отдаем Ajax
        if ($request->ajax()) {
            return view('products_categories.metrics.properties-list', compact('properties', 'properties_list', 'products_category_metrics'));
        }
