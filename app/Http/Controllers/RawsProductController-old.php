...
class RawsProductController extends Controller
{
    ...
    public function store(RawsProductRequest $request)
    {
        ...
        if ($raws_product) {
            ...
            if ($request->entity == 'raws_categories') {
                return redirect()->action('RawsCategoryController@index', ['id' => $request->raws_category_id]);
            }
    ...
    public function ajax_system_item(Request $request)
    {
        ...
        $item = RawsProduct::where('id', $request->id)->update(['system_item' => $system]);
    ...
    public function ajax_display(Request $request)
    {
        ...
        $item = RawsProduct::where('id', $request->id)->update(['display' => $display]);
