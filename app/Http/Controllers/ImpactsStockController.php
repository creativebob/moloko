...
class ImpactsStockController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->entityAlias = 'impacts_stocks';
    ...
    public function index()
    {
        ...
        $this->authorize(getmethod(__FUNCTION__), ImpactsStock::class);

        // Получаем из сессии необходимые данные (Функция находиться в Helpers)
        $answer = operator_right($this->entityAlias, $this->entityDependence, getmethod(__FUNCTION__));
        // dd($answer);

        $stocks = ImpactsStock::with([
            'cmv.article.unit',
            'cmv.category',
            'company',
        ])
