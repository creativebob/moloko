...
class UpdateController extends Controller
{
     ...
     * @return string
     */
    public function addShiftsEntity()
    {
        $pageData = [
            'name' => 'Смены',
            'site_id' => 1,
        ...
        $entity = Entity::where('alias', 'shifts')
            ->exists();
        ...
        if (!$entity) {
            ...
            // Наваливание прав
            $entities = Entity::where('alias', 'shifts')
                ->get();
            ...
            $entity = Entity::where('alias', 'photo_settings')
                ->update($entityData);
        }
    ...
    /**
     * Добавление в развернутую систему сущности настроек фотографий с правами
     *
     * @return string
     */
    public function addPhotoSettingsEntity()
    {
        $pageData = [
        ...
        $page = Page::where('alias', 'photo_settings')
            ->exists();
        ...
        $menu = Menu::where('tag', 'photo_settings')
            ->exists();
        ...
        if (!$entity) {
            ...
            // Наваливание прав
            $entities = Entity::where('alias', 'photo_settings')
                ->get();
        ...
        return "<strong>Добавление сущности настроек фотографий завершено</strong>";
    }
