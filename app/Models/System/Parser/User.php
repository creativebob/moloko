...
//            ])
    ...
    {
        return $this->morphToMany(Phone::class, 'phone_entity')->wherePivot('main', '=', 1)->whereNull('archive')->withPivot('archive');
    }
    ...
    {
        return $this->morphToMany(Phone::class, 'phone_entity')->whereNull('archive')->whereNull('main')->withPivot('archive');
    }
