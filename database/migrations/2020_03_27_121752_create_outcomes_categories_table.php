...
class CreateOutcomesCategoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('outcomes_categories', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('outcomes_categories');
    }
}
