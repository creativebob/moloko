...
class CreateContainersConsignmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('containers_consignments', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('containers_consignments');
    }
}
