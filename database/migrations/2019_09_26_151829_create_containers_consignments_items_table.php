...
class CreateContainersConsignmentsItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('containers_consignments_items', function (Blueprint $table) {
            ...
            $table->foreign('consignment_id')->references('id')->on('containers_consignments');
    ...
    {
        Schema::dropIfExists('containers_consignments_items');
    }
}
