...
class CreateImpactsCategoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('impacts_categories', function (Blueprint $table) {
...
//            $table->foreign('parent_id')->references('id')->on('impacts_categories');

            $table->bigInteger('category_id')->unsigned()->nullable()->comment('Id категории, пишется каждому вложенному пункту');
//            $table->foreign('category_id')->references('id')->on('impacts_categories');
...
//            $table->foreign('author_id')->references('id')->on('users');
    ...
    {
        Schema::dropIfExists('impacts_categories');
    }
}
