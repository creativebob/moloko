    ...
    public function run()
    {
        ...
        $page = Page::firstOrCreate(
            ...
            [
                ...
                'description' => 'Заявки поставщикам',
        ...
        $entity = Entity::where('alias', 'applications')->first();
        if ($entity) {
            $entity_id = $entity->id;
        } else {
            $entity = new Entity;
            $entity->name = 'Заявки поставщикам';
            $entity->alias = 'applications';
       ...
       $menu = new Menu;
       $menu->name = 'Заявки поставщикам';
       $menu->alias = 'admin/applications';
       $menu->tag = 'applications';
