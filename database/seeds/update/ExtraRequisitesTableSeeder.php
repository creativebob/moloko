...
class ExtraRequisitesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $entity = Entity::where('alias', 'extra_requisites')->first();
        if ($entity) {
            $entity_id = $entity->id;
        } else {
            $entity = new Entity;
            $entity->name = 'Дополнительные реквизиты';
            $entity->alias = 'extra_requisites';
            $entity->model = 'ExtraRequisite';
       ...
       $menu = new Menu;
       $menu->name = 'Дополнительные реквизиты';
       $menu->alias = 'admin/extra_requisites';
       $menu->tag = 'extra_requisites';
