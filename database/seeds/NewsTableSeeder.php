    ...
    public function run()
    {
       // Создаем новости дял сайта
    	DB::table('news')->insert([
    		...
    		[
    			'news_name' => 'Откатка скидка',
    			'site_id' => 2,
    			'news_title' => 'Откатные ворота из сэндвич-панелей Doorhan со скидкой 30%',
    			'news_preview' => 'Хорошие новости для тех, кто в ближайший месяц планирует приобретение автоматических уличных ворот.<br>Предлагаем готовое решение: производство и монтаж откатных ворот из сэндвич-панелей Doorhan для проема шириной до 4 метров.',
    			'news_description' => '<p>Хорошие новости для тех, кто в ближайший месяц планирует приобретение автоматических уличных ворот.</p><p>Предлагаем готовое решение: производство и монтаж откатных ворот из сэндвич-панелей Doorhan в алюминиевой раме для проема шириной до 4 метров по цене 79 999 рублей. В стоимость уже включены работы по монтажу и по подготовке основания.</p><p>При оформлении заказа на ворота предлагаем привод Sliding-1300 по цене: 15 999 рублей. Это очень выгодно!</p><p>На ваши вопросы ответим по телефону: 8(3952) 71-77-75</p>',
    			'news_alias' => 'skidka',
    			'company_id' => 1,
    			'system_item' => null,
    			'author_id' => 4,
        ...
        [
          'news_name' => 'Аэропорт',
          'site_id' => 2,
          'news_title' => 'Аэропорт в безопасности!',
          'news_preview' => 'Реконструкция периметрового ограждения в Международном аэропорту города Иркутска. Оснащение его средствами охраны и контроля доступа. Более 12 километров забора, восемь месяцев напряженной и интересной работы, десятки ворот и противотаранных шлагбаумов, СКУД.',
          'news_description' => '<p>Хорошие новости для тех, кто в ближайший месяц планирует приобретение автоматических уличных ворот.</p><p>Предлагаем готовое решение: производство и монтаж откатных ворот из сэндвич-панелей Doorhan в алюминиевой раме для проема шириной до 4 метров по цене 79 999 рублей. В стоимость уже включены работы по монтажу и по подготовке основания.</p><p>При оформлении заказа на ворота предлагаем привод Sliding-1300 по цене: 15 999 рублей. Это очень выгодно!</p><p>На ваши вопросы ответим по телефону: 8(3952) 71-77-75</p>',
          'news_alias' => null,
          'company_id' => 1,
          'system_item' => null,
        ...
        [
          'news_name' => 'Комплект откатки',
          'site_id' => 2,
          'news_title' => 'Комплектация для откатных ворот',
          'news_preview' => 'Планируете изготовить откатные ворота самостоятельно? Предлагаем готовое решение по комплектации откатных ворот весом до 400 кг.',
          'news_description' => '<h2 itemprop="name">Комплектация для откатных ворот</h2>
        ...
        [
          'news_name' => '80 ворот',
          'site_id' => 2,
          'news_title' => '80 ворот - легко!',
          'news_preview' => 'Совместно с компанией "МонолитСтрой - Иркутск" возведен парковочный комплекс на 80 гаражей. Все боксы оснащены современными автоматическими воротами Doorhan с дистанционным управлением. Также на трех въездах в гаражный кооператив были установлены откатные ворота. Весь комплекс работ был выполнен в течении одного месяца.',
