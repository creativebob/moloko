...
class EntitiesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Entity::insert([
            ...
            [
                'name' => 'Товарные накладные сырья',
                'alias' => 'raws_consignments',
                'model' => 'RawConsignment',
                'rights' => true,
                'system' => true,
                'author_id' => 1,
                'site' => 0,
                'metric' => 0,
                'view_path' => 'raws_consignments',
                'page_id' => $pages->firstWhere('alias', 'raws_consignments')->id,
            ],
	        [
		        'name' => 'Товарные накладные упаковок',
		        'alias' => 'containers_consignments',
		        'model' => 'ContainersConsignment',
		        'rights' => true,
		        'system' => true,
		        'author_id' => 1,
		        'site' => 0,
		        'metric' => 0,
		        'view_path' => 'containers_consignments',
		        'page_id' => $pages->firstWhere('alias', 'containers_consignments')->id,
	        ],
	        [
		        'name' => 'Товарные накладные товаров',
		        'alias' => 'goods_consignments',
		        ...
		        'site' => 0,
		        'metric' => 0,
		        'view_path' => 'goods_consignments',
		        'page_id' => $pages->firstWhere('alias', 'goods_consignments')->id,
	        ],
