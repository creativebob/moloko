    ...
    public function run()
    {
        ...
        Unit::insert([
            ...
            [
                ...
                'abbreviation' => 'мм',
                'ratio' => 0.001,
                'units_category_id' => $units_categories->where('name', 'Длина')->first()->id,
                'system_item' => 1,
                'author_id' => 1,
                'moderation' => null,
            ],
            ...
            [
                ...
                'abbreviation' => 'мг',
                'ratio' => 0.000001,
                'units_category_id' => $units_categories->where('name', 'Масса')->first()->id,
                'system_item' => 1,
                'author_id' => 1,
                'moderation' => null,
            ],
            ...
            [
                ...
                'abbreviation' => 'мс',
                'ratio' => 0.001,
                'units_category_id' => $units_categories->where('name', 'Время')->first()->id,
                'system_item' => 1,
                'author_id' => 1,
                'moderation' => null,
            ],
            ...
            [
                ...
                'abbreviation' => 'кв. мм',
                'ratio' => 0.001,
                'units_category_id' => $units_categories->where('name', 'Площадь')->first()->id,
                'system_item' => 1,
                'author_id' => 1,
                'moderation' => null,
            ],
            ...
            [
                ...
                'abbreviation' => 'куб. см',
                'ratio' => 0.000001,
                'units_category_id' => $units_categories->where('name', 'Обьем')->first()->id,
                'system_item' => 1,
                'author_id' => 1,
                'moderation' => null,
            ],
            ...
            [
                ...
                'abbreviation' => 'шт',
                'ratio' => 1,
                'units_category_id' => $units_categories->where('name', 'Количество')->first()->id,
                'system_item' => 1,
                'author_id' => 1,
                'moderation' => null,
            ],
            ...
            [
                ...
                'abbreviation' => '%',
                'ratio' => 1,
                'units_category_id' => $units_categories->where('name', 'Проценты')->first()->id,
                'system_item' => 1,
                'author_id' => 1,
                'moderation' => null,
            ],
            ...
            [
                ...
                'abbreviation' => '₽',
                'ratio' => 1,
                'units_category_id' => $units_categories->where('name', 'Валюта')->first()->id,
                'system_item' => 1,
                'author_id' => 1,
                'moderation' => null,
            ],
