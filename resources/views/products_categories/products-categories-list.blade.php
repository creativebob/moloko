...
@if (isset($products_category['children']))
  ...
  @endphp
@endif
<li class="medium-item item @if (isset($products_category['children'])) parent @endif" id="products_categories-{{ $products_category['id'] }}" data-name="{{ $products_category['name'] }}">
