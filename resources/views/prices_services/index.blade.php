...
@section('breadcrumbs', Breadcrumbs::render('prices_services-index', $catalog_services, $page_info))
...
{{--    @include('includes.title-content', ['page_info' => $page_info, 'class' => App\PricesService::class, 'type' => 'table'])--}}
    @include('prices_services.includes.title-prices_services', ['page_info' => $page_info, 'class' => $class])
