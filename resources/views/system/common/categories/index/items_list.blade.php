<li class="{{ isset($item->childrens) ? 'medium-item parent' : 'medium-as-last' }} item" id="{{ $entity }}-{{ $item->id }}" data-name="{{ $item->name }}">
    ...
    <div class="icon-list">
        <div class="controls-list">
            @include ('system.common.categories.index.control.categories_menu_div', ['item' => $item, 'class' => $class, 'color' => 'black'])
        </div>
        ...
        <div class="actions-list">
            ...
            <div class="del">
                @include('system.common.categories.index.control.item_delete_menu', ['item' => $item])
            </div>
        </div>
    </div>
