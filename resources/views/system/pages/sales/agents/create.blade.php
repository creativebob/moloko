...
@section('title-content')
    <div class="top-bar head-content">
        <div class="top-bar-left">
            <h2 class="header-content">ДОБАВЛЕНИЕ НОВОГО АГЕНТА</h2>
        </div>
...
@section('content')
    {{ Form::open(['route' => 'agents.store', 'data-abide', 'novalidate', 'files' => 'true']) }}
    @include('system.pages.companies.form', ['submitButtonText' => 'Добавить агента'])
    {{ Form::close() }}
@endsection
