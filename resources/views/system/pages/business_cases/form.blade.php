            ...
            <div class="tabs-panel is-active" id="options">
                ...
                <div class="grid-x grid-padding-x">
                    ...
                    <div class="small-12 medium-5 cell">
                        ...
                        {{-- Сайт --}}
                        <label>Название
                            @include('includes.inputs.name', ['value' => $business_case->name, 'required' => true])
                        </label>
                    ...
                    <div class="cell small-12 medium-7">
                        <photo-upload-component :photo='@json($business_case->photo)'></photo-upload-component>
                    </div>

                    {{-- Чекбоксы управления --}}
                    @include('includes.control.checkboxes', ['item' => $business_case])
