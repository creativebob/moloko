...
@section('breadcrumbs', Breadcrumbs::render('edit', $page_info, $domain->domain))

@section('title-content')
<div class="top-bar head-content">
    <div class="top-bar-left">
       <h2 class="header-content">РЕДАКТИРОВАТЬ домен</h2>
   </div>
...
{{ Form::model($domain, ['route' => ['domains.update', $domain->id], 'data-abide', 'novalidate']) }}
{{ method_field('PATCH') }}

@include('system.pages.domains.form', ['submit_text' => 'Редактировать'])
