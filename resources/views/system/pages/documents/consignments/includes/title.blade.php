        ...
        <div class="top-bar head-content">
            ...
            <div class="top-bar-right">
                ...
                @if(!(count(request()->input()) == 1 && request()->input(['page'])) && count(request()->input())) filtration-active @endif
                    "></a>
                <search-consignments-component></search-consignments-component>
            </div>
        </div>
            ...
            <div class="small-12 cell filters fieldset-filters" id="filters">
                ...
                <div class="grid-padding-x">
                    <div class="small-12 cell">
                        {{ Form::open(['route' => 'consignments.index', 'data-abide', 'novalidate', 'method'=>'GET', 'id' => 'filter-form', 'class' => 'grid-x grid-padding-x inputs']) }}

                        @include('system.pages.documents.consignments.includes.filters')
