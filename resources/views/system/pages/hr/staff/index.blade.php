...
{{-- Таблица --}}
@include('includes.title-content', ['pageInfo' => $pageInfo, 'class' => App\Department::class, 'type' => 'table'])
@endsection
    ...
    <div class="small-12 cell">
        <table class="content-table tablesorter" id="content" data-sticky-container data-entity-alias="staff">
            ...
            <tbody data-tbodyId="1" class="tbody-width">
                ...
                <tr class="item @if($staffer->moderation == 1)no-moderation @endif" id="staff-{{ $staffer->id }}" data-name="{{ isset($staffer->user) ? $staffer->user->name : 'Вакансия' }} ( {{ $staffer->position->name }} )" data-entity="staff" data-id="{{ $staffer->id }}">
