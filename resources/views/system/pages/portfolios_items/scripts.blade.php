<script type="application/javascript">
    ...
    $(function() {
        ...
        $(document).on('click', '[data-open="modal-create"]', function() {
            ...
            $.get('/admin/portfolios/' + portfolio_id + '/portfolios_items/create', {
        ...
        $(document).on('click', '.submit-create', function(event) {
            ...
            if (window.submitAjax(form.attr('id'))) {
                ...
                $.post('/admin/portfolios/' + portfolio_id + '/portfolios_items', form.serialize(), function(html) {
        ...
        $(document).on('click', '.sprite-edit', function() {
            ...
            $.get('/admin/portfolios/' + portfolio_id + '/portfolios_items/' + id + '/edit', function(html) {
                $('#modal').html(html);
        ...
        $(document).on('click', '.submit-edit', function(event) {
            ...
            if (window.submitAjax(form.attr('id'))) {
                ...
                // Ajax запрос
                $.ajax({
                    url: '/admin/portfolios/' + portfolio_id + '/portfolios_items/' + form.find('#item-id').val(),
                    type: "PATCH",
                    data: form.serialize(),
        ...
        $(document).on('click', '.delete-button-ajax', function(event) {
            ...
            // Ajax
            $.ajax({
                url: '/admin/portfolios/' + portfolio_id + '/portfolios_items/' + id,
                type: "DELETE",
                success: function (html) {
                    // alert(html);
