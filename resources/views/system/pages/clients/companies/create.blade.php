...
@section('breadcrumbs', Breadcrumbs::render('create-client', $pageInfo, 'createClientCompany'))
...
@section('content')
    ...
    {{ Form::open(['route' => 'clients.storeClientCompany', 'data-abide', 'novalidate', 'files' => 'true']) }}
        @include('system.pages.companies.form', ['submitButtonText' => 'Добавить клиента'])
    {{ Form::close() }}
