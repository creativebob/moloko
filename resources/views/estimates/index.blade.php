    ...
    <div class="small-12 cell">
      ...
      <tfoot>
          <tr>
              ...
              <th class="td-amount">{{ num_format($estimatesAll->sum('amount'), 0) }}</th>
              <th class="td-discount-currency">{{ num_format($estimatesAll->sum('discount_currency'), 0) }}</th>
              <th class="td-total">{{ num_format($estimatesAll->sum('total'), 0) }}</th>
