            ...
            <div class="cell small-12 medium-auto tour-main-block">
                                ...
                                @foreach($serviceFlow->events as $eventFlow)
                                    <li class="accordion-item" data-accordion-item>
                                        <a href="#" class="accordion-title">
                                            ...
                                            <span
                                                class="small-text">{{ $eventFlow->start_at->translatedFormat('j F, l') }}</span>
                ...
                <ul class="accordion gear" data-accordion data-allow-all-closed="true">
                    ...
                    <li class="accordion-item" data-accordion-item>
                        ...
                        <div class="accordion-content" data-tab-content>
                            <ul>
                                <li>Рюкзак штурмовой объёмом 35-45 литров для спортивных занятий и радиальных выходов
                                </li>
                        ...
                        <ul class="list-extra-info">
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>Проживание в Иркутске в гостиницах или хостеле, но мы модем помочь вам с
                                        размещением и выборов гостиницы
                                    </li>
                            ...
                            <li>
                                <h4>Проживание:</h4>
                                <p>На протяжении всей программы ночуем на туристических базах. Размещение в 3-х, 6-ти
                                    местных номерах. Тёплый душ, туалет на территории.</p>
                            </li>
                            <li>
