...
@section('breadcrumbs', Breadcrumbs::render('section-edit', $parent_pageInfo, $album, $pageInfo, $photo))
...
@section('content')
{{ Form::model($photo, ['route' => ['photos.update', $album->alias, $photo->id], 'data-abide', 'novalidate']) }}
{{ method_field('PATCH') }}
        ...
        <div class="grid-x grid-padding-x">
            ...
            <div class="small-12 medium-6 cell">
                <label for="head">Цвет (В случае необходимости)
                    ...
                    <input type="color" id="head" name="color" value="{{ isset($photo->color) ? $photo->color : '#e66465' }}" />
                </label>
            </div>
        </div>
    </div>
