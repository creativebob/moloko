      ...
      <tbody data-tbodyId="1" class="tbody-width">
        ...
        <tr class="item @if($photo->moderation == 1)no-moderation @endif" id="photos-{{ $photo->id }}" data-name="{{ $photo->name }}">
          ...
          <td class="td-checkbox checkbox">
            ...
            <td class="td-photo"><a href="/albums/{{ $album->alias }}/photos/{{ $photo->id }}/edit"><img src="/storage/{{ $photo->company->id }}/media/albums/{{ $album->id }}/small/{{ $photo->name }}" alt="Фотография альбома"></a></td>
