        ...
        <div class="small-5 right-head cell">
          <ul>
            ...
            <li>
              ...
              @endphp
              <img src="{{ isset(Auth::user()->photo_id) ? '/storage/'.Auth::user()->company_id.'/media/users/'.Auth::user()->id.'/img/'.Auth::user()->avatar->name : '/img/plug/'.$name }}" alt="Аватар" class="avatar">
            </a>
          </li>
        </ul>
