...
<div id="app">
    ...
    <div class="top-bar-container header-z-index" id="header" data-sticky-container>
        <div class="sticky sticky-topbar" data-sticky data-margin-top="0" data-options="stickyOn: small;"
            ...
            <header class="grid-x header">
                ...
                <div class="small-5 right-head cell">
                            ...
                            <li>
                                <a id="task-toggle"><img src="/img/system/header/alert.png">
                                    @if(!empty($list_challenges['for_me']))
                                        <span class="challenges_count"
                                              id="challenges-count">{{ $list_challenges['for_me']->flatten()->count() }}</span>
                                    @endif
                                </a>
                            </li>
                        @endcan
                    ...
                    <div class="dropdown-pane profile-head" id="profile" data-dropdown data-position="bottom"
                         data-alignment="right" data-v-offset="10" data-h-offset="-30" data-close-on-click="true">
