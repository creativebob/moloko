            ...
            <div class="small-12 medium-12 large-12 cell margin-left-15">
                ...
                <div class="tabs-panel" id="content-panel-history">
                    <div class="wrap-autofind">
                        <legend>Найдены обращения: {{ $lead->history->count() }}</legend>
                            ...
                            @if($lead->history->isNotEmpty())
                                ...
                                <div class="grid-x">
                                    <div class="small-12 medium-12 large-12 cell">
                                        <table class="">
                                            @foreach($lead->history as $historyLead)
                                                <tr>
                                                    <td>
                                                        {{ $historyLead->created_at->format('d.m.Y') }}
                                                    </td>
                                                    <td>
                                                        <span class="lead-name" id="lead-name" title="Использовать данные">{{ $historyLead->client->clientable->name ?? $historyLead->name}}</span><br>
                                                        <span id="lead-city" data-city-id="{{$historyLead->location->city->id ?? ''}}">{{$historyLead->location->city->name ?? '- Город не указан -'}}</span>,
                                                    ...
                                                    <td>
                                                        ...
                                                        @endif
                                                        <br>
                                                        №: <a href="/admin/leads/{{ $historyLead->id }}/edit" id="{{ $historyLead->id }}" title="Перейти">{{ $historyLead->case_number ?? ''}}</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </table>
