...
<li>
	...
	<div class="checker-nested" id="composition_category-{{ $raws_category->id }}">
		<ul class="checker">
			...
			<li class="checkbox">
				{{ Form::checkbox(null, $composition->id, in_array($composition->id, $article->compositions->pluck('id')->toArray()), ['class' => 'add-composition', 'id' => 'composition-'.$composition->id]) }}
...
<script type="text/javascript">
	...
	// Открываем модалку
	$(document).on('click', "#table-compositions a[data-open=\"delete-composition\"]", function() {
