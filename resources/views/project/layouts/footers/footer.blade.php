                    <footer class="grid-x grid-padding-x" id="footer">
                        <div class="cell small-12 medium-4 large-6 block-footer-1">
                            <span>&copy; @isset($filial->company->birthday_company){{ $filial->company->birthday_company->format('Y') . ' -' }} @endisset {{ date("Y") }} «{{ $filial->company->legal_form->name }} {{ $filial->company->name }}»</span>
                            <br>
