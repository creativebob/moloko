<script type="text/javascript">
	...
	function addNote (id, model) {
		$.ajax({
			...
			url: '/admin/notes',
			type: "POST",
			data: {id: id, model: model, body: $('input[name=add-body]').val()},
			success: function(html){
				$('#tr-add-note').after(html);
				$('input[name=add-body]').val('');
				$('input[name=add-body]').blur();
	...
	$(document).on('keydown', 'input[name=add-body]', function(event) {
