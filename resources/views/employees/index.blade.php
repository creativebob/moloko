...
{{-- Таблица --}}
@include('includes.title-content.table', ['page_info' => $page_info, 'class' => null])
@endsection
  ...
  <div class="small-12 cell">
    <table class="table-content tablesorter" id="table-content" data-sticky-container>
      ...
      @if(!empty($employees))
        ...
        <tr class="item @if($employee->moderation == 1)no-moderation @endif" id="employees-{{ $employee->id }}" data-name="{{ $employee->position_name }}">
