    ...
    <table class="table-content tablesorter" id="table-content" data-sticky-container>
      ...
      @if(!empty($sites))
        ...
        <tr class="parent" id="sites-{{ $site->id }}" data-name="{{ $site->site_name }}">
          ...
          <td class="td-site-name"><a href="/pages/{{ $site->id }}">{{ $site->site_name }}</a></td>
    ...
    <div class="grid-x grid-padding-x modal-content inputs">
      <div class="small-10 small-offset-1 cell">
        ...
        <label>Компания сайта:
          {{ Form::select('company_id', $companies, null, ['id'=>'site-company-select']) }}
        </label>
      </div>
    </div>
...
<div class="reveal" id="site-edit" data-reveal>
  ...
  {{ Form::open(['id'=>'form-site-edit', 'data-abide', 'novalidate']) }}
  {{ method_field('PATCH') }}
    <div class="grid-x grid-padding-x modal-content inputs">
      <div class="small-10 small-offset-1 cell">
        <label>Название сайта
        ...
        <label>Компания сайта:
          {{ Form::select('company_id', $companies, null, ['placeholder' => 'Системная компания', 'id'=>'site-company-select']) }}
        </label>
      </div>
    </div>
    <div class="grid-x align-center">
