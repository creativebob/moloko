...
export default {
    ...
    created() {
        ...
        this.$store.commit('SET_PAYMENTS', this.lead.estimate.payments);
    },
    computed: {
        isDisabled() {
        ...
        //     let delay = 300;
        //     return _.debounce(this.searchByPhone, delay);
        // }
    },
    methods: {
        change() {
        ...
        searchByPhone(number) {
            axios
                .get('/admin/leads/search-user-by-phone/' + number)
                .then(response => {
